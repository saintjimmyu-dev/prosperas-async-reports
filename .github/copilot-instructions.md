# Instrucciones del Workspace Prosperas

- Leer SSOT.md antes de tomar decisiones significativas de implementacion o arquitectura.
- Tratar SSOT.md como la constitucion activa para alcance, arquitectura, guardrails de costo y fases de entrega.
- La arquitectura seleccionada para este proyecto es Arquitectura Event-Driven Contenerizada sobre EC2.
