...
Version: 1.3.8
Status: Activo (Fase 6 cerrada; Fase 7 en ejecucion con B3 implementado, merge completado y ajuste IaC para exponer frontend en puerto 80 pendiente de terraform apply + validacion productiva final)
